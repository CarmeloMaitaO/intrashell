...
type
  ...
  ImportedDispatch* = proc(input: ptr Buffer, output: ptr Buffer, hostAllocator: HostsAllocator) {.cdecl, raises: [WrongParameters, CommandFailed].}
  ##[
...
template dispatchBoilerplate*(userSuppliedProc: UserSuppliedDispatch) =
  ...
  proc dispatch*(inputBuffer: ptr Buffer, outputBuffer: ptr Buffer, allocator: HostsAllocator) {.exportc, dynlib, cdecl, raises: [WrongParameters, CommandFailed].} =
    let
